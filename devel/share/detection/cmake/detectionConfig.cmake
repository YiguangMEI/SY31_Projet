...
if("TRUE" STREQUAL "TRUE")
  set(detection_SOURCE_PREFIX /home/aubinvert/Projet_SY31/src/detection)
  set(detection_DEVEL_PREFIX /home/aubinvert/Projet_SY31/devel)
  ...
  set(detection_INSTALL_PREFIX /home/aubinvert/Projet_SY31/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'myg <myg@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'detection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aubinvert/Projet_SY31/src/detection/${idir}'.  ${_report}")
    endif()
